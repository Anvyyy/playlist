...
func RegisterMusicServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MusicServiceServer) error {
	...
	mux.Handle("POST", pattern_MusicService_DeleteSong_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.MusicService/DeleteSong", runtime.WithHTTPPathPattern("/delete-song"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMusicServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MusicServiceClient) error {
	...
	mux.Handle("POST", pattern_MusicService_DeleteSong_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.MusicService/DeleteSong", runtime.WithHTTPPathPattern("/delete-song"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_MusicService_DeleteSong_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"delete-song"}, ""))
)
